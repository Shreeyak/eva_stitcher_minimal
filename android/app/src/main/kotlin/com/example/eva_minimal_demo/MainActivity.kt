...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        methodChannel =
                MethodChannel(flutterEngine.dartExecutor.binaryMessenger, METHOD_CHANNEL).also {
                        channel ->
        ...
        // ── EventChannel for status/diagnostic events ──
        eventsChannel =
                EventChannel(flutterEngine.dartExecutor.binaryMessenger, EVENTS_CHANNEL).also {
                        channel ->
